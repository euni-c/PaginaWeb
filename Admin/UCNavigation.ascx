...
<table width="200" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#990000"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">CRM Login</asp:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkHome">
      <td height="20">&nbsp;</td>
      <td bgcolor="	#FFFFCC">&nbsp;</td>
      <td height="20" bgcolor="#990000"><ASP:HyperLink CssClass="izq" id="lnkHome"
				 navigateurl="Main.aspx" runat="server">Home</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlblVentas" >
      <td height="20" style="HEIGHT: 21px">&nbsp;</td>
      <td width="4" bgcolor="#FFFFCC" style="HEIGHT: 21px">&nbsp;</td>
      <td height="20" bgcolor="#990000" class="titleBlanco" style="HEIGHT: 21px">
    ...
    <tr id="divlnkAddVenta" >
      ...
      <td height="20" bgcolor="#990000">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx">Nueva Venta</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="CC0000">&nbsp;</td>
      <td height="20" bgcolor="#990000">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink
    ...
    <tr id="divlblProductos" >
      ...
      <td height="20" bgcolor="#990000" class="titleBlanco">
    ...
    <tr id="divlnkChangePassword" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#FFFFCC">&nbsp;</td>
      <td height="20" bgcolor="#990000" classname="izq"><ASP:HyperLink id="lnkChangePassword" class="izq"
    ...
    <tr id="divlnkLogout" >
      ...
      <td width="4" bgcolor="#FFFFCC" style="HEIGHT: 20px">&nbsp;</td>
      <td height="20" bgcolor="#990000" style="HEIGHT: 20px">
        <p>
