...
BODY {
	BACKGROUND-IMAGE: url(Images/fondo.jpg); BACKGROUND-COLOR: #ff6a00
}
</style>
</head>
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#996633">
    <tr>
      <td colspan="4"><img src="Images/top_fifiu.jpg" width="1000" height="143"></td>
    </tr>
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#FFFFFF"> <uc1:UCNavigation id="UserControl1" runat="server"></uc1:UCNavigation></td>
      <td colspan="3" valign="top"><img src="Images/bk_loginCrm" width="800" height="80"></td>
    </tr>
    <tr>
...
<tr>
            ...
            <form id="Form1" runat="server">
                ...
                <td width="202" height="20" align="left" valign="middle">
                        ...
                        <tr>
                          <td height="1" colspan="4" align="right" valign="middle" bgcolor="#ffffff"><img src="Images/1.gif" width="1" height="1" /></td>
                        </tr>
                        <tr>
    ...
    <tr>
      <td width="200" height="30" bgcolor="#993300">&nbsp;</td>
      <td width="10" bgcolor="#993300">&nbsp;</td>
      <td width="770" bgcolor="#993300">&nbsp;</td>
